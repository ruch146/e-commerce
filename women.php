...
<img src="imag/wo.jpg">
<h2 ><center>WOMEN'S COLLECTION</center ></h2>
...
if(isset($_POST['button1'])){
	$sql="SELECT * FROM men WHERE pprice BETWEEN 200 AND 1000 AND pgender IN('F')";
...
<?php 	
	...
	$sql="SELECT * FROM men WHERE pprice BETWEEN 1000 AND 2000 AND pgender IN('F')";
	$result=mysqli_query($conn,$sql);
	 if(mysqli_num_rows($result)>0)
		 {
		 	while($row = mysqli_fetch_array($result))
...
<?php 	
	...
	$sql="SELECT * FROM men WHERE pprice BETWEEN 2000 AND 3000 AND pgender IN('F')";
	$result=mysqli_query($conn,$sql);
	 if(mysqli_num_rows($result)>0)
		 {
		 	while($row = mysqli_fetch_array($result))
	...
	$sql="SELECT * FROM men where pgender IN('F') ORDER BY pprice DESC";
	$result=mysqli_query($conn,$sql);
	 if(mysqli_num_rows($result)>0)
		 {
		 	while($row = mysqli_fetch_array($result))
	...
	$sql="SELECT * FROM men where pgender IN('F') ORDER BY pprice ASC";
	$result=mysqli_query($conn,$sql);
	 if(mysqli_num_rows($result)>0)
		 {
		 	while($row = mysqli_fetch_array($result))
    ...
    <?php 	
		 ...
		 $query="SELECT * FROM men WHERE pgender='F'";
